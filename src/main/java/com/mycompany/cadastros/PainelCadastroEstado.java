 ...
 * @author danilo silva
 */
public class PainelCadastroEstado extends PainelCadastros {

    /**
     * Creates new form PainelCadastroEstado
     */
    public PainelCadastroEstado() {
        initComponents();
    }
...
private Estado estado;
    ...
    public EntidadesVirtuais getDados() {
            ...
            estado.setUf(jTextField2.getText().toUpperCase());
            estado.setNome(jTextField1.getText().toUpperCase());
       return estado;
    }

    @Override
    public void setDados(EntidadesVirtuais ev) {
        this.estado = (Estado) ev;
        jTextField1.setText(estado.getNome()); 
        jTextField2.setText(estado.getUf()); 
    }
}
